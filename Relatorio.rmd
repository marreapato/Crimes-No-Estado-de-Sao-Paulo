...
## Resultados e Discussão
 ...
 O Índice Global de Moran **(Tabela 1)** foi alto para o número de homicídios por 100 mil habitantes, indicando que há um nível de dependência espacial para a ocorrência deste crime no estado, ou seja existem aglomerados para a ocorrência deste crime dentre as regiões da Unidade Federativa.
