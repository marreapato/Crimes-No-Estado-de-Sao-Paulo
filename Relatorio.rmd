...
## Resultados e Discussão
 ...
 O Índice Global de Moran **(Tabela 1)** foi alto para o número de homicídios por 100 mil habitantes, indicando que há um nível de dependência espacial para a ocorrência deste crime no estado, ou seja existem aglomerados dentre as regiões da Unidade Federativa em que a ocorrência deste crime está com uma maior notabilidade.
