...
## Conclusão
 ...
 Apesar das limitações de nosso trabalho, no geral os índices globais de Moran indicam que uma ação deve ser tomada em conjunto em todo o estado para a diminuição da quantidade de homicídios e furtos no estado, apesar de que a diminuição de todos os índices de criminalidade deve ser visada, os índices locais de Moran podem dar uma visão local de como combater o aumento desses índices de maneira mais eficiente, visto que são os agrupamentos que mais se destacaram negativamente na unidade federativa.
